        ...
        <div class="col-md-12 col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Tambah Pesawat</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <form action="{{ route('pesawats.store') }}" method="POST" class="form form-horizontal">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8 form-group">
                                        <input type="text" id="kode_pesawat" class="form-control @error('kode_pesawat') is invalid @enderror" name="kode_pesawat"
                                            placeholder="Masukan Kode Pesawat" value="{{ old('kode_pesawat') }}">
                                            @error('kode_pesawat')
                                    ...
                                    <div class="col-md-8 form-group">
                                        <input type="text" id="nama_pesawat" class="form-control @error('nama_pesawat') is invalid @enderror" name="nama_pesawat"
                                            placeholder="Masukan Nama Pesawat" value="{{ old('nama_pesawat') }}">
                                            @error('nama_pesawat')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                    </div>
                                    ...
                                    <div class="col-md-8 form-group">
                                        <input type="text" id="type" class="form-control @error('type') is invalid @enderror" name="type"
                                            placeholder="Masukan Type Pesawat" value="{{ old('type') }}">
                                            @error('type')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                    </div>
                                    ...
                                    <div class="col-md-8 form-group">
                                        <input type="text" id="tahun_rakit" class="form-control @error('tahun_rakit') is invalid @enderror" name="tahun_rakit"
                                            placeholder="Masukan Tahun Rakit Pesawat" value="{{ old('tahun_rakit') }}">
                                            @error('tahun_rakit')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                    </div>
